...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/vapor/auth-provider.git", .upToNextMajor(from: "1.1.0")),
    ...
    targets: [
        .target(name: "App", dependencies: ["Vapor", "LeafProvider", "FluentProvider", "AuthProvider", "MySQLProvider", "ValidationProvider"],
               exclude: [
                   "Config",
                   "Database",
                   "Public",
